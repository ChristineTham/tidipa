...
As an alternate path which is used for the translation, the same bespoke HTML files are also converted to Markdown using a [Python script](https://github.com/tidipa/convert-scripts/blob/main/wt2md.py). The Markdown files generated are fed into the translation process.
