...
```mermaid
graph
A["√śram"] --> B["śrama (a)"] --- C["śrama (b)"] --- D["śramaṇa = one who perfoms śrama (b)"]
A --> D
```
...
```mermaid
graph
A["√śram"] --> B["śrama (a)"] --- C["śrama (b)"] --- D["śramaṇa (b) = one who perfoms śrama (b)"]
B --- E["śramaṇa (a)"]
E --- D
A --> D
```
...
```mermaid
graph
A["√śram"] --> B["śrama (a)"] --- C["śrama (b)"] --- D["śramaṇa (b)"] --- F["śramaṇa (c)"]
A --> E["śramaṇa (a)"]
E --- D
B --- E
D --> G["śrāmaṇaka"]
